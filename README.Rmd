...
The package `{wig}` provides an example WIG file that contains H3K4me3 ChIP-Seq analysis of breast variant human mammary epithelial cell from RM035 (HS2615) using Illumina Genome Analyzer IIx.

The file has already been trimmed to a region where the gene PIK3CA can be found: chromosome 3, starting position 178,861,000 and ending position 178,894,000 (assembly hg19).

You can find more details about this sample in GEO: [GSM613874](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM613874).
